...
public class NodeStyleDefinition implements StyleDefinition {
    ...
    /**
     * Constructs a new {@code NodeStyleDefinition} with the given map of styles.
     * The provided map of styles is typically generated by a
     * {@code com.brunomnsilva.fluentfxcss.stylers.concrete.FluentNodeStyler}
     * and contains styles applicable to {@link javafx.scene.Node}.
     *
     * @param styles A map where keys are CSS property names and values are their
     *               CSS string representations, relevant for {@code Node} styling.
